...
describe("Band Score Modification Saga", function () {
  const generator = cloneableGenerator(bandScoreModificationSaga)();
  ...
  const zeroGenerator = cloneableGenerator(bandScoreModificationSaga)();
  const undoValue = 1;
